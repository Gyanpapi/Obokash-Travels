  ...
  <div class="reservation-form">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-12">
          <form id="reservation-form" name="gs" method="POST" role="search" action="<?php echo e(route('traveling.reservation.store',$city->id)); ?>">
            <?php echo csrf_field(); ?>
            <div class="row">
              <div class="col-lg-12">
              ...
              <div class="col-lg-12">
                  <fieldset>
                      ...
                      <input type="hidden" value="<?php echo e($city->name); ?>" name="destination" class="Name" required>
              ...
              <div class="col-lg-12">
                  ...
                  <fieldset>
                      ...
                      <input type="hidden" value="<?php echo e(Auth::user()->id); ?>" name="user_id" class="Name" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/obokashtravel/resources/views/traveling/reservation.blade.php ENDPATH**/ ?>